...
app.route('/newticket/:user/:team/:title/:prio/:desc')
    .post(function (req, res, err) {
        ...
        dbPromise.then((id) => {
            ...
            db.promise().query('START TRANSACTION;INSERT INTO Tickets (team_id, ticket_title, ticket_status, opened_by, creation_date) VALUES ('+id[0].team_id+',"'+title+'",'+0+', "'+user+'","'+timestamp+'"); INSERT INTO Ticket_Data (ticket_desc, priority) VALUES ("'+desc+'","'+prio+'");COMMIT;');
