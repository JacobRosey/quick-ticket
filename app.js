...
app.route('/index/:admin/:team')
    .post(function (req, res, err) {
        ...
        dbPromise.then(() => {
            ...
            db.query("START TRANSACTION;INSERT INTO Teams (team_name, team_code) VALUES ('"+ team + "', '" + teamCode + "'); SET @last_id = (SELECT LAST_INSERT_ID()); INSERT INTO Admins (user_id, team_id) VALUES ("+userID+", @last_id);COMMIT;", (err, result) => {
                if(err){
                    console.log(err)
