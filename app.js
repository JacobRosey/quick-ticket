...
app.route('/index/:admin/:team')
    .post(function (req, res, err) {
        ...
        dbPromise.then(() => {
            ...
            db.query("INSERT INTO Teams (team_name, team_code) VALUES ("+ db.escape(team) + ", " + db.escape(teamCode) + "); SET @last_id = (SELECT LAST_INSERT_ID()); INSERT INTO Admins (user_id, team_id) VALUES ("+db.escape(userID)+", @last_id);", (err, result) => {
                if(err){
                    console.log(err)
