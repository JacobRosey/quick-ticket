            ...
            for(let i=0; i<res.length; i++){
                inviteContainer.innerHTML +=
                    ...
                    <div style="display: flex; flex-direction: row;">
                        ...
                        <a class="btn" onclick="teamInviteResponse(true, `+res[i]+`)" role="button" style="float: right; color: white; background-color: green; margin: auto; font-weight: bolder; font-size: 1em; width: auto; line-height: 32.5px !important;"><i class="bi bi-check"></i></a>
                        <a class="btn" onclick="teamInviteResponse(false, `+res[i]+`)" role="button" style="float: right; color: white; background-color: red; margin: auto; font-weight: bolder; font-size: 1em; width: auto; line-height: 32.5px !important;"><i class="bi bi-x"></i></a></span>
                    </div>
                    `
            }
        } else {
