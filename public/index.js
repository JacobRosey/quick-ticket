            ...
            for (let i = 0; i < res.length; i++) {
                container.innerHTML += `
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" id="team-code" >Invitation Code: <span style="font-weight: 300;">`+ res[i].team_code + `</span> <i class="bi bi-send-plus" onClick="inviteNewMember(); style="color: #ccc; float: right;"></i></li>
