...
function useResponse(res) {
    ...
    if (res == "Not on a team") {
        ...
        <div style="display: flex; flex-direction: row;"><i class="fs-4 bi-people" style="margin-right: 15px; margin-top: 5px;"></i><p class="text-center" style="font-weight: bold;">You are not a member of a team!</p></div>
