            ...
            container.innerHTML +=
                ...
                <tbody>
                    ...
                    <i class="bi bi-circle" style="transform: scale(1.5)" data-toggle="tooltip"
                        ...
                        <td style="--color: #ff914c;--size: calc(` + pastWeekOpened.length + ` / ` + topOfRange + `); margin: .5em 1.75em .75em 1.75em; ">` + pastWeekOpened.length + `&nbsp;&nbsp;</td>
                    </tr>
                    <tr>
                    <th scope="col"> <i class="bi bi-x-circle" style="transform: scale(1.5)"
                    data-toggle="tooltip" data-placement="top" title="Tickets Closed"></i>
                    </th>
                        <td style="--color: #c084f5;--size: calc(` + pastWeekClosed.length + ` / ` + topOfRange + `); margin: .5em 1.75em .75em 1.75em;">` + pastWeekClosed.length + `&nbsp;&nbsp;</td>
                    </tr>
                    </tbody> 
                </table>
                `;
