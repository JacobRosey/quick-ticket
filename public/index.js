            ...
            for (let i = 0; i < res.length; i++) {
                inviteContainer.innerHTML +=
                    ...
                    <div style="display: flex; flex-direction: row; justify-content: right;">
                        ...
                        <a class="btn" onclick="teamInviteResponse(true, `+ res[i] + `)" role="button" style="background-color: #198753; margin: .15em; margin-left: 1em; width: auto; line-height: 32.5px !important;"><i class="bi bi-check" style="color: white; font-weight: bolder; font-size: 1.5em;"></i></a>
                        <a class="btn" onclick="teamInviteResponse(false, `+ res[i] + `)" role="button" style="background-color: #dd3444; margin: .15em; width: auto; line-height: 32.5px !important;"><i class="bi bi-x" style="color: white; font-weight: bolder; font-size: 1.5em;"></i></a></span>
                    </div>
                    `
            }
        } else {
