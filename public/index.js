    ...
    if (active.includes('ticket')) {
        ...
        if (res[0] == 'team_names') {
            if(res.length == 1){
                ...
                `
                <div class="jumbotron">
                <div style="display:grid; align-items:start;"><i class="bi bi-plus-circle"></i><p class="text-center" style="font-weight: bold;">You can't create a ticket; you're not on a team!</p></div>
