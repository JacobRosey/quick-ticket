            ...
            for (let i = 0; i < res.length; i++) {
                container.innerHTML += `
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item" id="team-code" >Invitation Code: <span style="font-weight: 300;">`+ res[i].team_code + `</span> <i class="bi bi-send-plus" style="color: #ccc; float: right; cursor: pointer;" onMouseOver="this.style.color="color: #5e5e5e"; onMouseOut="this.style.color="ccc"; onClick="inviteNewMember();"></i></li>
